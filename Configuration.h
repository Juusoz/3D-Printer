...
#define CUSTOM_MACHINE_NAME "The best goddamn 3D-printer!"
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 99.5, 99.5, 392.8, 117.2, 85 }
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 30, 0, -1.3 }
